...
import 'package:sadaqah_manager/util/utils/typedefs.dart';

import 'package:sadaqah_manager/util/utils/my_alert_dialog.dart';
import 'package:flutter/material.dart';
import 'package:flutter/foundation.dart';
import 'package:sadaqah_manager/util/countries.dart';
          ...
          _filteredCountries = _allCountries
              .where((Country country) =>
                  ...
                  country.isoCode.toLowerCase().startsWith(value.toLowerCase()) ||
                      ...
                      country.currencySymbol.toLowerCase().startsWith(value.toLowerCase())
