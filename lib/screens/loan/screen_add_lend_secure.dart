...
class AddLend extends StatefulWidget {
  ...
  final position;
  String courencyCode;
  AddLend(this.loan, this.appBarTitle, this.button, this.finaluerid,
      this.position, this.courencyCode);
  @override
  State<StatefulWidget> createState() {
    return AddLendState(this.loan, this.appBarTitle, this.button,
        this.finaluerid, this.position, this.courencyCode);
  }
}

// Create a corresponding State class.
// This class holds data related to the form.
class AddLendState extends State<AddLend> {
  final finaluserid;
  ModelLoan loan;
  String button;
  String appBarTitle;
  int position;
  String currencyCode;
  AddLendState(this.loan, this.appBarTitle, this.button, this.finaluserid,
      this.position, this.currencyCode);
  ...
  List<ModelLoan> loanList = List<ModelLoan>();
                  ...
                  new Theme(
                    ...
                    child: new TextFormField(
                      ...
                      decoration: new InputDecoration(
                          ...
                          hintText: 'Give about your Lend (Secure)',
...
//                      child: new Text(
//                        button, style: new TextStyle(color: Colors.white),),
//                      color: Colors.red,
//                      onPressed: () {
//                                setState(() {
...
//    if (result != 0) { // Success
//      _showAlertDialog('Status', 'Loan (Secure) Added Successfully');
//    } else { // Failure
//      _showAlertDialog('Status', 'Problem Saving Loan');
//    }
      moveToLastScreen();
    }
  }
  ...
  void updateListView() {
    ...
    dbFuture.then((database) {
      Future<List<ModelLoan>> cashListFuture =
          databaseHelper.getLoanList('loan', 'lendsecure', this.finaluserid);
  ...
  void _delete(BuildContext context, ModelLoan loan) async {
    ...
    if (result != 0) {
      _showSnackBar(context, 'Loan (secure) Deleted Successfully');
    }
  }
